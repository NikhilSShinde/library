                                                     ...
                                                     <div class="table-toolbar">
                                                        ...
                                                        <form class="navbar-form navbar-left" id="frm_filter" name="frm_filter" method="POST">
                                                          <div class="row" class="col-md-12">
                                                                <div class="col-md-1">
                                                                        <div class="btn-group">
                                                                                <a href="{{url('admin/create-star-user')}}" id="sample_editable_1_new" class="btn green">
                                                                ...
                                                                <div class="col-md-2">
                                                                    ...
                                                                    <select class="form-control" id="order_country"  name="order_country">
                                                                        ...
                                                                        <option value="{{str_replace("+","",$name->id)}}">{{$name->translate()->name}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                    @endif
                                                                </div>                                                              
                                                               <div class="col-md-7">
                                                                 <form class="navbar-form navbar-left" id="frm_filter" name="frm_filter" method="POST">
                                                                            ...
                                                                            <div class="form-group" style="margin-left: 28px;">
                                                                                <input type="text" class="form-control" id="start_date" name="start_date" placeholder="Delivery Date">
                                                                            </div>
    ...
    function initDatatable()
            {
                  $("#tbladminusers").dataTable().fnDestroy();
                     $('#tbladminusers').DataTable({
                        ...
                        serverSide: true,
                        bStateSave: true,
                        ajax: {"url":'{{url("/admin/star-users-data")}}',
...
jQuery.browser = {};
    ...
    $('#tbladminusers').DataTable({
        ...
        serverSide: true,
        bStateSave: true,
        ajax: {"url":'{{url("/admin/star-users-data")}}',"complete":afterRequestComplete},
        columnDefs: [{
        "defaultContent": "-",
        "targets": "_all"
      }],
