...
<div class="page-content-wrapper">
		<div class="page-content">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="javascript:void(0)">Manage Company Users</a>
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="glyphicon glyphicon-globe"></i>Manage Company Users
							</div>
							<div class="tools">
							...
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-2">
										<div class="btn-group">
											<a href="{{url('admin/create-company-user')}}" id="sample_editable_1_new" class="btn green">
							...
							<tr>
								<th>
									<div class="cust-chqs">  <p><input type="checkbox" id="select_all_delete" ><label for="select_all_delete"></label>  </p></div>
                                                       ...
                                                       <input type="button" onclick='javascript:deleteAll("{{url('/admin/delete-company-selected-user')}}")' name="delete" id="delete" value="Delete Selected" class="btn btn-danger">              						</div>
					</div>
...
function initDatatable()
{
      $("#tbladminusers").dataTable().fnDestroy(); 
       $('#tbladminusers').DataTable({
        ...
        serverSide: true,
        bStateSave: true,
        ajax: {"url":'{{url("/admin/company-users-data")}}',
            ...
            {data:   "Update",
              render: function ( data, type, row ) {
                    ...
                    if ( type === 'display' ) {
                        ...
                        return '<a class="btn btn-sm btn-primary" href="{{url("admin/update-company-user/")}}/'+row.user_id+'">Update</a>';
                    }
                    return data;
                },
                  "orderable": false,
...
//            }, 
              ...
              render: function ( data, type, row ) {
                    ...
                    if ( type === 'display' ) {
                        ...
                        return '<a class="btn btn-sm btn-primary" href="{{url("admin/view-company-stars/")}}/'+row.user_id+'">Stars</a>';
                    }
                    return data;
                },
                  "orderable": false,
            ...
            {data:   "Delete",
              render: function ( data, type, row ) {
                    ...
                    if ( type === 'display' ) {
                        ...
                        return '<form id="delete_user_'+row.user_id+'" method="post" action="{{url("/admin/delete-company-user")}}/'+row.user_id+'">{{ method_field("DELETE") }} {!! csrf_field() !!}<button onclick="confirmDelete('+row.user_id+')" class="btn btn-sm btn-danger" type="button">Delete</button></form>';
                    }
                    return data;
                },
                  "orderable": false,
...
$(function() {
    $('#tbladminusers').DataTable({
        ...
        serverSide: true,
        bStateSave: true,
        ajax: {"url":'{{url("/admin/company-users-data")}}',"complete":afterRequestComplete},
        columnDefs: [{
        "defaultContent": "-",
        "targets": "_all"
      }],
