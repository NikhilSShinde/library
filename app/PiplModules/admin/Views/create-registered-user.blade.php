...
<div class="page-content-wrapper">
		<div class="page-content">
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<a href="javascript:void(0)">Create New Customer</a>
        ...
        <div class="portlet box blue">
             <div class="portlet-title">
                        <div class="caption">
                                <i class="fa fa-gift"></i> Create Customer
                        </div>

             </div>
             <div class="portlet-body form">
              <form role="form" name="frm_regsitered_user" id="frm_regsitered_user" class="form-horizontal"  method="post" >
                         ...
                         <div class="col-md-6">    
                            <select class="form-control" name="mobile_code" id="mobile_code">
                             <option value="" selected="">--Select--</option>
                                @foreach($countries as $country)
                                    @if($country->id!='17')
                                     <option @if (old("mobile_code") == $country->country_code) selected @endif value="{{$country->country_code}}">{{$country->country_code}}</option>
                                    @endif 
                                @endforeach
