...
@section('content')
    ...
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="javascript:void(0)">Agent User Profile</a>
            </li>
        </ul>
                    ...
                    <div class="portlet light">
                        <div class="portlet-title tabbable-line">
                            <div class="caption caption-md">
                                ...
                                <span class="caption-subject font-blue-madison bold uppercase">Agent User Profile</span>
                            </div>
                        ...
                        <div class="portlet-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane @if(!($errors->has('email') || $errors->has('confirm_email')|| $errors->has('current_password')|| $errors->has('new_password') || $errors->has('confirm_password') || session('password-update-fail'))) active @endif" id="tab_1_1">
                                    <form name="update_profile"  id="update_profile" role="form" method="POST" action="{{ url('/admin/update-agent-profile-post') }}">
                                        {!! csrf_field() !!}
                                        ...
                                        <div class="form-group{{ $errors->has('limit_to_pay_to_star') ? ' has-error' : '' }}">
                                            <label class="control-label">Amount limit on, you will star pay to star</label>

                                            <input type="text" class="form-control" name="limit_to_pay_to_star" value="{{old('limit_to_pay_to_star',$user_info->userInformation->limit_to_pay_to_star)}}">
                                            ** This will help to show you the star whose balance reached to this limit, so you can track that and pay them **
                                            @if ($errors->has('limit_to_pay_to_star'))
                                            <span class="help-block">
                                                <strong>{{ $errors->first('limit_to_pay_to_star') }}</strong>
                                            </span>
                                            @endif
