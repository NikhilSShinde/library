...
<title>Update Company User Profile</title>
...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="javascript:void(0);">Update Company User Profile</a>
            </li>
        </ul>
                    ...
                    <div class="portlet light">
                        <div class="portlet-title tabbable-line">
                            <div class="caption caption-md">
                                ...
                                <span class="caption-subject font-blue-madison bold uppercase">Update Company User Profile</span>
                            </div>
                        ...
                        <div class="portlet-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane @if(!($errors->has('email') || $errors->has('confirm_email')|| $errors->has('current_password')|| $errors->has('new_password') || $errors->has('confirm_password') || session('password-update-fail'))) active @endif" id="tab_1_1">
                                    <form name="update_profile"  id="update_profile" role="form" method="POST" action="{{ url('/admin/update-company-user/'.$user_info->id)}}">
                                        {!! csrf_field() !!}
                                ...
                                <div class="tab-pane @if($errors->has('email') || $errors->has('confirm_email'))  active @endif" id="tab_1_3">
                                    <form name="update_email"  id="update_email" role="form" method="POST" action="{{ url('/admin/update-company-user-email/'.$user_info->id) }}">
                                        {!! csrf_field() !!}
                                ...
                                <div class="tab-pane @if($errors->has('current_password')|| $errors->has('new_password') || $errors->has('confirm_password') || session('password-update-fail')) active @endif" id="tab_1_2">
                                    <form name="update_password"  id="update_password" role="form" method="POST" action="{{ url('/admin/update-company-user-password/'.$user_info->id) }}">
                                        {!! csrf_field() !!}
