...
<title>Update Free Toner User Profile </title>
...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="{{url('admin/free-toner-users')}}">Manage Free Toner users</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <a href="javascript:void(0);">Update Free Toner User Profile</a>
            </li>
        </ul>
                    ...
                    <div class="portlet light">
                        <div class="portlet-title tabbable-line">
                            <div class="caption caption-md">
                                ...
                                <span class="caption-subject font-blue-madison bold uppercase">Update Free Toner User Profile</span>
                            </div>
                        ...
                        <div class="portlet-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane @if(!($errors->has('email') || $errors->has('confirm_email')|| $errors->has('current_password')|| $errors->has('new_password') || $errors->has('confirm_password') || session('password-update-fail'))) active @endif" id="tab_1_1">
                                    <form name="frm_agent_update"  id="frm_agent_update" role="form" method="POST" action="{{ url('/admin/update-free-toner-user/'.$user_info->id)}}">
                                        {!! csrf_field() !!}
                                ...
                                <div class="tab-pane @if($errors->has('email') || $errors->has('confirm_email'))  active @endif" id="tab_1_3">
                                    <form name="frm_agent_update_email"  id="frm_agent_update_email" role="form" method="POST" action="{{ url('/admin/update-free-toner-user-email/'.$user_info->id) }}">
                                        {!! csrf_field() !!}
                                        ...
                                        <div class="margiv-top-10">
                                            ...
                                            <a href="{{url('/admin/free-tonner-users')}}" class="btn default">
                                                Cancel 
                                            </a>
                                        </div>
                                    </form>
                                ...
                                <div class="tab-pane @if($errors->has('current_password')|| $errors->has('new_password') || $errors->has('confirm_password') || session('password-update-fail')) active @endif" id="tab_1_2">
                                    <form name="frm_agent_update_password"  id="frm_agent_update_password" role="form" method="POST" action="{{ url('/admin/update-free-toner-user-password/'.$user_info->id) }}">
                                        {!! csrf_field() !!}
                                        ...
                                        <div class="margiv-top-10">
                                            ...
                                            <a href="{{url('/admin/free-toner-users')}}" class="btn default">
                                                Cancel 
                                            </a>
                                        </div>
                                    </form>
