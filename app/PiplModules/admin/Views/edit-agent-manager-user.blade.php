...
<title>Update Agent Manager User Profile</title>
...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="{{url('admin/agent-managers-users')}}">Manage Agent Manager users</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <a href="javascript:void(0);">Update Agent Manager User Profile</a>
            </li>
        </ul>
                    ...
                    <div class="portlet light">
                        <div class="portlet-title tabbable-line">
                            <div class="caption caption-md">
                                ...
                                <span class="caption-subject font-blue-madison bold uppercase">Update Agent Manager User Profile</span>
                            </div>
                        ...
                        <div class="portlet-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane @if(!($errors->has('email') || $errors->has('confirm_email')|| $errors->has('current_password')|| $errors->has('new_password') || $errors->has('confirm_password') || session('password-update-fail'))) active @endif" id="tab_1_1">
                                    <form name="update_profile"  id="update_profile" role="form" method="POST" action="{{ url('/admin/update-agent-manager-user/'.$user_info->id)}}">
                                        {!! csrf_field() !!}
                                ...
                                <div class="tab-pane @if($errors->has('email') || $errors->has('confirm_email'))  active @endif" id="tab_1_3">
                                    <form name="update_agent_email"  id="update_agent_email" role="form" method="POST" action="{{url('/admin/update-agent-manager-user-email/'.$user_info->id) }}">
                                        {!! csrf_field() !!}
                                ...
                                <div class="tab-pane @if($errors->has('current_password')|| $errors->has('new_password') || $errors->has('confirm_password') || session('password-update-fail')) active @endif" id="tab_1_2">
                                    <form name="update_password_agent_manager"  id="update_password_agent_manager" role="form" method="POST" action="{{ url('/admin/update-agent-manager-user-password/'.$user_info->id) }}">
                                        {!! csrf_field() !!}
