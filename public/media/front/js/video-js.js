...
(function () {
    ...
    t.options = {techOrder: ["html5", "flash"], html5: {}, flash: {},  defaultVolume: 0, playbackRates: [], inactivityTimeout: 2E3, children: {mediaLoader: {}, posterImage: {}, textTrackDisplay: {}, loadingSpinner: {}, bigPlayButton: {}, controlBar: {}, errorDisplay: {}}, language: document.getElementsByTagName("html")[0].getAttribute("lang") || navigator.languages && navigator.languages[0] || navigator.ze || navigator.language || "en", languages: {}, notSupportedMessage: "No compatible source was found for this video."};
    ...
    t.c = function (a, c, d) {
        ...
        e.W || (e.disabled = l, e.W = function (c) {
            if (!e.disabled) {
                ...
                var d = e.C[c.type];
                if (d)
                    for (var d = d.slice(0), j = 0, n = d.length; j < n && !c.zc(); j++)
                        d[j].call(a, c)
            }
        });
    ...
    t.g.qd = function (a, c) {
        ...
        a = t.g.copy(a);
        for (d in c)
            v.call(c, d) && (e = a[d], g = c[d], a[d] = t.g.Ta(e) && t.g.Ta(g) ? t.g.qd(e, g) : c[d]);
        return a
    };
    t.g.copy = function (a) {
        return t.g.z({}, a)
    ...
    t.ga.Va = function (a, c) {
        ...
        a = t.g.copy(a);
        for (d in c)
            c.hasOwnProperty(d) && (e = a[d], g = c[d], a[d] = t.g.Ta(e) && t.g.Ta(g) ? t.ga.Va(e, g) : c[d]);
        return a
    };
    t.a = t.qa.extend({i: function (a, c, d) {
            ...
            if (c.Jc !== l) {
                var e, g;
                this.k().reportUserActivity && (e = t.bind(this.k(), this.k().reportUserActivity), this.c("touchstart", function () {
                    e();
                    clearInterval(g);
                    g = setInterval(e, 250)
                }), a = function () {
                    e();
                    clearInterval(g)
                }, this.c("touchmove", e), this.c("touchend",
                        a), this.c("touchcancel", a))
            }
        }});
    s = t.a.prototype;
    s.dispose = function () {
        ...
        if (this.P)
            for (var a = this.P.length - 1; 0 <= a; a--)
                this.P[a].dispose && this.P[a].dispose();
    ...
    s.removeChild = function (a) {
        ...
        if (a && this.P) {
            for (var c = l, d = this.P.length - 1; 0 <= d; d--)
                if (this.P[d] === a) {
                    c = f;
                    this.P.splice(d, 1);
                    break
    ...
    s.c = function (a, c, d) {
        var e, g, h;
        "string" === typeof a || t.g.isArray(a) ? t.c(this.b, a, t.bind(this, c)) : (e = t.bind(this, d), h = this, g = function () {
            h.j(a, c, e)
        }, g.r = e.r, this.c("dispose", g), d = function () {
            h.j("dispose", g)
        }, d.r = e.r, a.nodeName ? (t.c(a, c, e), t.c(a, "dispose", d)) : "function" === typeof a.c && (a.c(c, e), a.c("dispose", d)));
        return this
    };
    s.j = function (a, c, d) {
        !a || "string" === typeof a || t.g.isArray(a) ? t.j(this.b, a, c) : (d = t.bind(this, d), this.j("dispose", d), a.nodeName ? (t.j(a, c, d), t.j(a, "dispose", d)) : (a.j(c, d), a.j("dispose", d)));
        return this
    };
    s.R = function (a, c, d) {
        var e, g, h;
        "string" === typeof a || t.g.isArray(a) ? t.R(this.b, a, t.bind(this, c)) : (e = t.bind(this, d), g = this, h = function () {
            g.j(a, c, h);
    ...
    function G(a) {
        ...
        a.c("touchmove", function (a) {
            1 < a.touches.length ? g = l : d && (j = a.touches[0].pageX - d.pageX, n = a.touches[0].pageY - d.pageY, r = Math.sqrt(j * j + n * n), 22 < r && (g = l))
        });
        h = function () {
            g = l
        };
    ...
    s.e = function (a, c) {
        var d;
        c = t.g.z({className: this.T(), role: "button", "aria-live": "polite", tabIndex: 0}, c);
        d = t.a.prototype.e.call(this, a, c);
        c.innerHTML || (this.v = t.e("div", {className: "vjs-control-content"}), this.xb = t.e("span", {className: "vjs-control-text", innerHTML: this.t(this.ua) || "Need Text"}), this.v.appendChild(this.xb), d.appendChild(this.v));
        return d
    };
    s.T = function () {
    ...
    s.e = function (a, c) {
        ...
        c = t.g.z({role: "slider", "aria-valuenow": 0, "aria-valuemin": 0, "aria-valuemax": 100, tabIndex: 0}, c);
    ...
    s.Z = function (a) {
        if (37 == a.which || 40 == a.which)
            a.preventDefault(), this.Nc();
        else if (38 == a.which || 39 == a.which)
            a.preventDefault(), this.Oc()
    };
    s.Xa = function () {
        t.j(document, "keyup", t.bind(this, this.Z))
    };
    ...
    t.$.prototype.e = function (a, c) {
        ...
        c = t.g.z({innerHTML: '<span class="vjs-control-text">' + this.defaultValue + "</span>"}, c);
    ...
    t.J = t.u.extend({i: function (a, c) {
            t.u.call(this, a, c);
            this.selected(c.selected)
        }});
    t.J.prototype.e = function (a, c) {
        return t.u.prototype.e.call(this, "li", t.g.z({className: "vjs-menu-item", innerHTML: this.t(this.m.label)}, c))
    };
    ...
    s.xa = function () {
        ...
        this.options().title && a.ja().appendChild(t.e("li", {className: "vjs-menu-title", innerHTML: t.ba(this.options().title), he: -1}));
        if (this.Q = this.createItems())
    ...
    for (var K = 0; K < t.D.Ra.length; K++)
        t.D[t.D.Ra[K]] = K, t.D.prototype[t.D.Ra[K]] = K;
    var L, M, N, O;
    ...
    t.Player = t.a.extend({i: function (a, c, d) {
            ...
            t.Ca[this.L] = this;
            c.plugins && t.g.X(c.plugins, function (a,
                    c) {
                this[a](c)
            }, this);
            var e, g, h, j, n, r;
            ...
            this.c("mousemove", function (a) {
                if (a.screenX != n || a.screenY != r)
                    n = a.screenX, r = a.screenY, e()
            });
    ...
    function da(a) {
        ...
        if (a.hasChildNodes()) {
            ...
            for (h = a.length; g < h; g++)
                c = a[g], d = c.nodeName.toLowerCase(), "source" === d ? e.sources.push(t.Aa(c)) : "track" === d && e.tracks.push(t.Aa(c))
        }
        return e
    }
    s.e = function () {
    ...
    function Q(a, c, d) {
        ...
        a.eb = c;
        a.la = l;
        var e = t.g.z({source: d, parentEl: a.b}, a.m[c.toLowerCase()]);
        d && (a.nc = d.type, d.src == a.G.src && 0 < a.G.currentTime && (e.startTime = a.G.currentTime), a.G.src = d.src);
    ...
    function S(a, c) {
        if (a.o && a.o.la)
            try {
                ...
                throw a.o[c] === b ? t.log("Video.js: " + c + " method not defined for " + a.eb + " playback technology.", d) : "TypeError" == d.name ? (t.log("Video.js: " + c + " unavailable on " + a.eb + " playback technology element.", d), a.o.la = l) : t.log(d), d;
            }
    }
    s.play = function () {
        T(this, "play");
    ...
    s.duration = function (a) {
        if (a !== b)
            return this.G.duration = parseFloat(a), this;
    ...
    s.volume = function (a) {
        if (a !== b)
            return a = Math.max(0, Math.min(1, parseFloat(a))), this.G.volume = a, T(this, "setVolume", a), t.ae(a), this;
    ...
    s.requestFullscreen = function () {
        ...
        })), this.b[a.requestFullscreen]()) : this.o.Ea() ? T(this, "enterFullScreen") : (this.qc(), this.l("fullscreenchange"));
        return this
    };
    s.requestFullScreen = function () {
    ...
    s.exitFullscreen = function () {
        ...
        if (a)
            ...
            this.o.Ea() ? T(this, "exitFullScreen") : (this.Cb(), this.l("fullscreenchange"));
        return this
    };
    ...
    s.src = function (a) {
        if (a === b)
            return S(this, "src");
        t.g.isArray(a) ? U(this, a) : "string" === typeof a ? this.src({src: a}) : a instanceof Object && (a.type && !window.videojs[this.eb].canPlaySource(a) ? U(this, [a]) : (this.G.src = a.src, this.nc = a.type || "", this.K(function () {
            T(this, "src", a.src);
    ...
    function U(a, c) {
        ...
        d ? d.o === a.eb ? a.src(d.source) : Q(a, d.o, d.source) : (e = setTimeout(t.bind(a, function () {
            this.error({code: 4, message: this.t(this.options().notSupportedMessage)})
    ...
    s.controls = function (a) {
        return a !== b ? (a = !!a, this.yb !== a && ((this.yb = a) ? (this.p("vjs-controls-disabled"), this.n("vjs-controls-enabled"), this.l("controlsenabled")) : (this.p("vjs-controls-enabled"), this.n("vjs-controls-disabled"), this.l("controlsdisabled"))), this) : this.yb
    };
    t.Player.prototype.Tb;
    s = t.Player.prototype;
    s.usingNativeControls = function (a) {
        return a !== b ? (a = !!a, this.Tb !== a && ((this.Tb = a) ? (this.n("vjs-using-native-controls"), this.l("usingnativecontrols")) : (this.p("vjs-using-native-controls"), this.l("usingcustomcontrols"))), this) : this.Tb
    };
    s.da = k;
    s.error = function (a) {
        if (a === b)
            return this.da;
        if (a === k)
            return this.da = a, this.p("vjs-error"), this;
    ...
    s.userActive = function (a) {
        return a !== b ? (a = !!a, a !== this.Sb && ((this.Sb = a) ? (this.pa = f, this.p("vjs-user-inactive"), this.n("vjs-user-active"), this.l("useractive")) : (this.pa = l, this.o && this.o.R("mousemove", function (a) {
            a.stopPropagation();
            a.preventDefault()
        }), this.p("vjs-user-active"), this.n("vjs-user-inactive"), this.l("userinactive"))), this) : this.Sb
    };
    ...
    t.Ja = t.a.extend();
    t.Ja.prototype.m = {we: "play", children: {playToggle: {}, currentTimeDisplay: {}, timeDivider: {}, durationDisplay: {}, remainingTimeDisplay: {}, liveDisplay: {}, progressControl: {}, fullscreenToggle: {}, volumeControl: {}, muteToggle: {}, playbackRateMenuButton: {}}};
    t.Ja.prototype.e = function () {
        return t.e("div", {className: "vjs-control-bar"})
    };
    t.Yb = t.a.extend({i: function (a, c) {
            t.a.call(this, a, c)
        }});
    ...
    t.ac = t.u.extend({i: function (a, c) {
            t.u.call(this, a, c);
    ...
    t.hb = t.a.extend({i: function (a, c) {
            t.a.call(this, a, c);
    ...
    t.ib = t.a.extend({i: function (a, c) {
            t.a.call(this, a, c);
            this.c(a, "timeupdate", this.fa)
        }});
    ...
    t.Ka = t.u.extend({i: function (a, c) {
            t.u.call(this, a, c)
        }});
    ...
    t.lb = t.a.extend({i: function (a, c) {
            t.a.call(this, a, c);
    ...
    t.rb = t.a.extend({i: function (a, c) {
            t.a.call(this, a, c);
    ...
    t.hc = t.a.extend({i: function (a, c) {
            t.a.call(this, a, c)
        }});
    ...
    t.ia = t.u.extend({i: function (a, c) {
            t.u.call(this, a, c);
    ...
    t.ia.prototype.update = function () {
        ...
        for (a = 0; 4 > a; a++)
            t.p(this.b, "vjs-vol-" + a);
        t.n(this.b, "vjs-vol-" + c)
    };
    t.sa = t.N.extend({i: function (a, c) {
            t.N.call(this, a, c);
            this.c(a, "volumechange", this.update);
            a.o && a.o.featuresVolumeControl === l && this.n("vjs-hidden");
            this.c(a, "loadstart", function () {
    ...
    t.sa.prototype.xa = function () {
        var a = new t.ha(this.d, {lc: "div"}), c = new t.qb(this.d, this.m.volumeBar);
        c.c("focus", function () {
    ...
    t.bc = t.N.extend({i: function (a, c) {
            t.N.call(this, a, c);
            this.Tc();
            this.Sc();
    ...
    s = t.bc.prototype;
    s.e = function () {
        var a = t.a.prototype.e.call(this, "div", {className: "vjs-playback-rate vjs-menu-button vjs-control", innerHTML: '<div class="vjs-control-content"><span class="vjs-control-text">' + this.t("Playback Rate") + "</span></div>"});
        this.Ac = t.e("div", {className: "vjs-playback-rate-value", innerHTML: 1});
    ...
    s.xa = function () {
        ...
        if (c)
            for (var d = c.length - 1; 0 <= d; d--)
                a.V(new t.nb(this.k(), {rate: c[d] + "x"}));
        return a
    };
    s.oa = function () {
    ...
    t.nb = t.J.extend({lc: "button", i: function (a, c) {
    ...
    t.ra = t.u.extend({i: function (a, c) {
            t.u.call(this, a, c);
            this.update();
    ...
    t.Zb = t.a.extend({i: function (a, c) {
            t.a.call(this, a, c)
        }});
    ...
    t.jb = t.a.extend({i: function (a, c) {
            t.a.call(this, a, c);
            this.update();
    ...
    t.q = t.a.extend({i: function (a, c, d) {
            ...
            this.featuresTimeupdateEvents || (a = this.d, this.Lb = f, this.c(a, "play", this.Rc), this.c(a, "pause", this.cb), this.R("timeupdate", function () {
    ...
    t.h = t.q.extend({i: function (a, c, d) {
            ...
            t.q.call(this, a, c, d);
            for (d = t.h.kb.length - 1; 0 <= d; d--)
                this.c(t.h.kb[d], this.vd);
            if ((c = c.source) && this.b.currentSrc !== c.src || a.I && 3 === a.I.Bd)
                this.b.src = c.src;
    ...
    s.e = function () {
        ...
        if (!c || this.movingMediaElementInDOM === l)
            c ? (d = c.cloneNode(l), t.h.Bb(c), c = d, a.I = k) : (c = t.e("video"), t.Kc(c, t.g.z(a.ie || {}, {id: a.id() + "_html5_api", "class": "vjs-tech"}))), c.player = a, t.Hb(c, a.w());
    ...
    s.vd = function (a) {
        "error" == a.type && this.error() ? this.k().error(this.error().code) : (a.bubbles = l, this.k().l(a))
    };
    s.play = function () {
        this.b.play()
    };
    ...
    t.f = t.q.extend({i: function (a, c, d) {
            ...
            var e = c.source;
            d = c.parentEl;
            var g = this.b = t.e("div", {id: a.id() + "_temp_flash"}), h = a.id() + "_flash_api", j = a.m, j = t.g.z({readyFunction: "videojs.Flash.onReady", eventProxyFunction: "videojs.Flash.onEvent", errorEventProxyFunction: "videojs.Flash.onError", autoplay: j.autoplay, preload: j.Da, loop: j.loop, muted: j.muted}, c.flashVars), n = t.g.z({wmode: "opaque", bgcolor: "#000000"}, c.params), h = t.g.z({id: h, name: h, "class": "vjs-tech"}, c.attributes);
            e && (e.type && t.f.Gd(e.type) ?
                    (e = t.f.Pc(e.src), j.rtmpConnection = encodeURIComponent(e.wb), j.rtmpStream = encodeURIComponent(e.Rb)) : j.src = encodeURIComponent(t.tc(e.src)));
            t.Hb(g, d);
            ...
            t.Zc && this.K(function () {
                this.c("mousemove", function () {
                    this.k().l({type: "mousemove", bubbles: l})
                })
            });
    ...
    t.f.vb = function (a) {
        ...
        if (a in t.f.yd || a in t.f.Qc)
            return"maybe"
    };
    t.f.yd = {"video/flv": "FLV", "video/x-flv": "FLV", "video/mp4": "MP4", "video/m4v": "MP4"};
    t.f.Qc = {"rtmp/mp4": "MP4", "rtmp/flv": "FLV"};
    ...
    t.f.Ad = function (a, c, d, e) {
        ...
        d = t.g.z({movie: a, flashvars: g, allowScriptAccess: "always", allowNetworking: "all"}, d);
        t.g.X(d, function (a, c) {
            h += '<param name="' + a + '" value="' + c + '" />'
        });
        e = t.g.z({data: a, width: "100%", height: "100%"}, e);
    ...
    t.ed = t.a.extend({i: function (a, c, d) {
            t.a.call(this, a, c, d);
    ...
    function Y(a, c, d) {
        for (var e = a.Fa, g = 0, h = e.length, j, n; g < h; g++)
            j = e[g], j.id() === c ? (j.show(), n = j) : d && (j.M() == d && 0 < j.mode()) && j.disable();
    ...
    function na(a) {
        0 === a.na && a.load();
        0 === a.ma && (a.d.c("timeupdate", t.bind(a, a.update, a.L)), a.d.c("ended", t.bind(a, a.reset, a.L)), ("captions" === a.H || "subtitles" === a.H) && a.d.ka("textTrackDisplay").V(a))
    }
    s.load = function () {
        ...
        if (0 < this.ca.length) {
            ...
            if (this.Pb === b || a < this.Pb || this.Wa <= a) {
                ...
                for (; ; ) {
                    r = c[w];
                    if (r.ya <= a)
                        e = Math.max(e, r.ya), r.Na && (r.Na = l);
                    else if (a < r.startTime) {
                        if (d = Math.min(d, r.startTime), r.Na && (r.Na = l), !g)
                            break
                    } else
                        g ? (h.splice(0, 0, r), n === b && (n = w), j = w) : (h.push(r), j === b && (j = w), n = w), d = Math.min(d,
                                r.ya), e = Math.max(e, r.startTime), r.Na = f;
                    if (g)
                        if (0 === w)
                            break;
                        else
    ...
    t.fc = t.a.extend({i: function (a, c, d) {
            ...
            if (a.m.tracks && 0 < a.m.tracks.length) {
                ...
                for (var e = 0; e < a.length; e++)
                    d = a[e], ma(c, d.kind, d.label, d.language, d)
            }
        }});
    ...
    t.mb = t.aa.extend({i: function (a, c) {
            c.track = {M: function () {
                    return c.kind
                }, k: a, label: function () {
                    return c.kind + " off"
    ...
    t.mb.prototype.update = function () {
        for (var a = this.d.textTracks(), c = 0, d = a.length, e, g = f; c < d; c++)
            e = a[c], e.M() == this.ea.M() && 2 == e.mode() && (g = l);
        this.selected(g)
    };
    t.U = t.N.extend({i: function (a, c) {
            t.N.call(this, a, c);
            1 >= this.Q.length && this.Y()
        }});
    t.U.prototype.wa = function () {
        var a = [], c;
        a.push(new t.mb(this.d, {kind: this.H}));
        for (var d = 0; d < this.d.textTracks().length; d++)
            c = this.d.textTracks()[d], c.M() === this.H && a.push(new t.aa(this.d, {track: c}));
        return a
    };
    ...
    t.Ma = t.U.extend({i: function (a, c, d) {
            t.U.call(this, a, c, d);
    ...
    s.xa = function () {
        for (var a = this.d.textTracks(), c = 0, d = a.length, e, g, h = this.Q = []; c < d; c++)
            if (e = a[c], e.M() == this.H)
                if (0 === e.readyState())
                    e.load(), e.c("loaded", t.bind(this, this.xa));
                else {
                    g = e;
                    break
                }
        a = this.Ba;
        a === b && (a = new t.ha(this.d), a.ja().appendChild(t.e("li", {className: "vjs-menu-title", innerHTML: t.ba(this.H), he: -1})));
        if (g) {
            e = g.ca;
            for (var j, c = 0, d = e.length; c < d; c++)
                j = e[c], j = new t.gb(this.d, {track: g, cue: j}), h.push(j), a.V(j);
            this.V(a)
        }
        0 < this.Q.length && this.show();
        return a
    };
    t.gb = t.J.extend({i: function (a, c) {
        ...
        t.JSON.parse = function (a, c) {
            function d(a, e) {
                ...
                if (r && "object" === typeof r)
                    for (j in r)
                        Object.prototype.hasOwnProperty.call(r, j) && (n = d(r, j), n !== b ? r[j] = n : delete r[j]);
                return c.call(a, e, r)
            }
            var e;
            a = String(a);
